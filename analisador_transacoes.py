...
lista_de_transacoes = carrega("c:/Users/Usuario/OneDrive/projetos/openai/dados/transacoes.csv")
if not lista_de_transacoes:
    print("Erro: O arquivo 'transacoes.csv' não foi encontrado ou está vazio.")
    exit(1)
